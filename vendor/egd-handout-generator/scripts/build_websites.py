...
def _inject_analytics(html, procedure_id, location_id, lang):
    ...
    html = render._inject_shared_mobile_a11y(html)
...
def build_procedure_sites(procedure_id, data, written):
    ...
    for location_id, repo_dir in site_out.items():
        ...
        # .gitignore/README only-if-missing; _headers always rewritten so
        # security-header changes propagate to already-initialized repos.
