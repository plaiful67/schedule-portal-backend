...
SAMPLES = [
    ...
    ("combined suprep over-50 SCC en", "en", True,
     lambda: bowel_prep.render_pdf(band_id="over-50", location_id="scc", lang="en",
                                   variant="combined", prep_type="suprep", audience="office")),
    ("combined lactulose 21-30 PMCH es", "es", False,
     lambda: bowel_prep.render_pdf(band_id="21-30", location_id="pmch", lang="es",
                                   variant="combined", prep_type="lactulose", audience="office")),
